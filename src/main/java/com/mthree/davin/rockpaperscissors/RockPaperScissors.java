...
//TODO 
// read user input x2 and error/type checking
// check REQS re overall winner - coudl igore ties in terms of overall winner or deduct one point for a tie?
// tidy code eg var/func names & conventions
// sort our vars for each round score re user/computer/tie etc - ok now
// change to do-while loop, until user says No
// sort out GH Classroom and commit/push
// review flowchart and reqs
...
public class RockPaperScissors {
    ...
    public static void startGame(int numberOfRounds) {
        ...
        //int computerScore = 0;
        //int tieScore = 0;
        //check stuff or force to lowercase - arayItems[] ?
        ...
        if (numberOfRounds >=1 && numberOfRounds <=10 ) {
            ...
            for (int index=1; index <= numberOfRounds; index++) {
                ...
                //userInput is really the int they enter, passed into the optionsArray
                ...
                int rInt = rGen.nextInt(optionsArray.length);
